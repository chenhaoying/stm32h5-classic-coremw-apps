/**
  ******************************************************************************
  * @file    stm32h573i_discovery_bus.c
  * @author  MCD Application Team
  * @brief   This file provides a set of firmware functions to communicate
  *          with  external devices available on STM32H573I-DK board
...
/** @defgroup STM32H573I_DK_BUS BUS
  * @{
  */

/** @defgroup STM32H573I_DK_BUS_Private_Constants BUS Private Constants
  * @{
  */
...
/** @defgroup STM32H573I_DK_BUS_Private_Types BUS Private Types
  * @{
  */
typedef struct
{
...
/** @defgroup STM32H573I_DK_BUS_Private_Variables BUS Private Variables
  * @{
  */
...
/** @defgroup STM32H573I_DK_BUS_Exported_Variables BUS Exported Variables
  * @{
  */
...
/** @defgroup STM32H573I_DK_BUS_Private_FunctionPrototypes BUS Private FunctionPrototypes
  * @{
  */
...
/** @defgroup STM32H573I_DK_BUS_Exported_Functions BUS Exported Functions
  * @{
  */
...
/** @defgroup STM32H573I_DK_BUS_Private_Functions BUS Private Functions
  * @{
  */
/**
